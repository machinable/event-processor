...
# ENV CGO_ENABLED=0
ENV SRC_DIR=${HOME}/go/src/github.com/machinable/event-processor/
...
ENTRYPOINT ["/go/src/github.com/machinable/event-processor/app"]
...
COPY --from=builder /go/src/github.com/machinable/event-processor/app /bin/app
